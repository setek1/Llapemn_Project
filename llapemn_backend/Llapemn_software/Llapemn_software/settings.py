"""
Django settings for Llapemn_software project.
...
SECRET_KEY = 'django-insecure-$6)^ed7%%0%_4k5fa!2yip^-ia%+$wd1k!-+(49(#1l5*=7jq*'
...
ROOT_URLCONF = 'Llapemn_software.urls'
...
WSGI_APPLICATION = 'Llapemn_software.wsgi.application'
