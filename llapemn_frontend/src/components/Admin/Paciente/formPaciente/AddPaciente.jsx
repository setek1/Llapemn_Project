...
function newSchame() {
  return {
    ...
    apellido: Yup.string().required("a"),
    dni: Yup.string().required("a"),
    ...
    alergias: Yup.string().required("a"),
    medicamentos_actuales: Yup.string().required("a"),
    enfermedades_previas: Yup.string().required("a"),
    cirugias_previas: Yup.string().required("a"),
    fecha_ingreso: Yup.string().required("a"),
    seguro_medico: Yup.string().required("a"),
    observaciones: Yup.string().required("a"),
  };
}
