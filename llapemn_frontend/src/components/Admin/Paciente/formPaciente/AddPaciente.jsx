...
function newSchame() {
  return {
    ...
    apellido: Yup.string().required("Por favor, ponga un apellido"),
    dni: Yup.string()
      .matches(/^[0-9.k-]+$/, "El DNI solo puede contener números, k, puntos y guiones")
    ...
    tipo_sangre: Yup.string().required(""),
    medico_referente: Yup.string().required(""),
    telefono_contacto_emergencia: Yup.string().required(""),
    nombre_contacto_emergencia: Yup.string().required(""),
    relacion_contacto_emergencia: Yup.string().required(""),
    alergias: Yup.string().required(""),
    medicamentos_actuales: Yup.string().required(""),
    enfermedades_previas: Yup.string().required(""),
    cirugias_previas: Yup.string().required(""),
    fecha_ingreso: Yup.string().required(""),
    seguro_medico: Yup.string().required(""),
